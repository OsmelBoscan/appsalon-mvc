...
function iniciarApp() {
    mostrarSeccion(); // Muestra y oculta secciones según el paso
    tabs(); // Cambia de sección cuando se presionen los tabs
    botonesPaginador(); // Cambia de sección cuando se presionen los botones de paginador
    paginaSiguiente(); 
    paginaAnterior(); 
...
function seleccionarServicio(servicio) {
    ...
    // Comprobar si el servicio ya está en el arreglo
...
function mostrarAlerta(mensaje, tipo, elemento, desaparece = true) {
    // Previene que se muestren múltiples alertas
